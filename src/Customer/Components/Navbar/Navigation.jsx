  ...
  categories: [
    {
      ...
      featured: [
        ...
        {
          name: "Custom made Women's Cloths",
          href: "/",
          imageSrc:
      ...
      featured: [
        {
          ...
          href: "#",
          imageSrc:
            "https://th.bing.com/th/id/OIP.Dv339g5hKF_0GGiuZnbvHgHaHa?rs=1&pid=ImgDetMain",
          imageAlt:
            "Drawstring top with elastic loop closure and textured interior padding.",
        },
        {
          name: "Custom made kid's Cloths",
          href: "#",
          imageSrc:
            "https://images.footlocker.com/content/dam/final/kidsfootlocker/site/homepage/2024/may/240501-kfl-83032-shop-by-brand-4up-refresh-crocs.jpg",
          imageAlt:
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="/">
                  <p className="text-xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-fuchsia-500">
                    KAVITA BOUTIQUE
                  </p>
                </a>
              </div>
                          ...
                          <div className="relative flex">
                            <Popover.Button
                              className={classNames(
                                ...
                                `relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out ${category.isDisabled}`
                              )}
                            >
                              {category.name}
                            </Popover.Button>
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  ...
                  >
                    <Badge
                      color="secondary"
                      badgeContent={cart.cart?.totalItem}
                    >
                      <ShoppingCartIcon />
                    </Badge>
