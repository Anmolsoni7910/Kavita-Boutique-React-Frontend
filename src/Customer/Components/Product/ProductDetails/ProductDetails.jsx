...
const reviews = { href: "#", average: 4, totalCount: 5 };
...
export default function ProductDetails() {
  ...
  const jwt = localStorage.getItem("jwt");
   console.log("param",productId,product?.product)
    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        <nav aria-label="Breadcrumb">
          ...
          >
            {customerProduct.breadcrumbs.map((breadcrumb) => (
        ...
        <section className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-2 px-4 pt-10">
          ...
          <div className="flex flex-col items-center ">
            <div className=" overflow-hidden rounded-lg max-w-[30rem] max-h-[35rem]">
              <img
                src={activeImage?.src || product?.product?.imageUrl}
                alt={customerProduct.images[0].alt}
                className="h-full w-full object-cover object-center"
              />
            </div>
            <div className="flex flex-wrap space-x-5 justify-center">
              {customerProduct.images.map((image) => (
                <div
                ...
                >
                  <img
                    src={image.src}
                    alt={customerProduct.images[1].alt}
                    className="h-full w-full object-cover object-center"
                  />
                </div>
              ))}
                ...
                <div className="mt-10">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-4 gap-4 sm:grid-cols-8 lg:grid-cols-10">
                      {customerProduct.sizes.map((size) => (
                        <RadioGroup.Option
                          key={size.name}
                          value={size}
            ...
            <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
              ...
              <div className="mt-10">
                ...
                <div className="mt-4">
                  <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
                    {customerProduct.highlights.map((highlight) => (
              ...
              <div className="mt-10">
                ...
                <div className="mt-4 space-y-6">
                  <p className="text-sm text-gray-600">{customerProduct.details}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3 pb-10">
                  ...
                  <p className="opacity-60">5Ratings</p>
                </div>
                <Box>
                  <Grid
                    container
