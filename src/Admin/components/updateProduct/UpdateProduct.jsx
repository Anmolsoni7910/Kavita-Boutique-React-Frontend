...
import { updateProduct } from '../../../Redux/Admin/Product/Action.js'
...
function UpdateProduct() {
    ...
    const [productData, setProductData] = useState({
      ...
      useEffect(()=>{
        if(adminProduct.product){
            for(let key in productData){
        setProductData((prev)=>({...prev,[key]:adminProduct.product[key]}))
        console.log(adminProduct.product[key],"--------",key)
    }
        }
