...
import { deleteProduct } from "../../../Redux/Admin/Product/Action.js";
import { findProducts } from '../../../Redux/Customers/Product/Action.js';
...
function Products() {
    ...
    useEffect(() => {
      ...
      }, [availability, category, sort,page,adminProduct.deleteProduct]);
